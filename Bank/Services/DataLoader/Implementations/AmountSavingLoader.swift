...
struct AmountSavingLoader: GenericSingleDataLoaderProtocol {
    ...
    private func loadOnlineFile(params: Params) async throws -> Params? {
        let loader = LoadFileStrategy_amountSaving()
    ...
    private func parse(params: DataParseParams) throws -> AmountSavingResponseModel? {
        switch params {
        case let params as DataParseParams_amountSaving:
            let parser = ParseStrategy_amountSaving()
